class HubPage extends React.Component {
  ...
  render() {
    return (
      <div>
        <header>
          <div className="container-fluid header-content fixed-top">
            <div className="row">
              ...
              <div className="col">
                <div className="float-right header-label">Kavrankaba</div>
              </div>
            </div>
          </div>
        </header>
...
class GamePage extends React.Component {
  ...
  componentDidMount() {
    const chatSocket = new WebSocket(
      "ws://" + window.location.host + "/ws/game/" + "qwe" + "/"
    );
      ...
      <div>
        <header>
          <div className="container-fluid header-content fixed-top">
            <div className="row">
              <div className="col">
                <div className="float-left header-label">⮨ Room name</div>
              </div>
              <div className="col">
                <div className="logo">
                  <u>NOIR</u>
